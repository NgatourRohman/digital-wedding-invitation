        ...
        if (distance < 0) {
            ...
            document.getElementById("countdown-section").innerHTML = `
                <div class="text-center py-16">
                    <div class="font-serif text-3xl md:text-5xl text-primary">Happily Ever After</div>
                </div>
            `;
        }
    }, 1000);
...
function populateCouple(couple) {
    ...
    document.getElementById('groom-parents').innerHTML = `Son of Mr. <span class="font-semibold text-slate-900 dark:text-slate-100">${groom.father}</span> &amp; Mrs. <span class="font-semibold text-slate-900 dark:text-slate-100">${groom.mother}</span>`;
    ...
    document.getElementById('bride-parents').innerHTML = `Daughter of Mr. <span class="font-semibold text-slate-900 dark:text-slate-100">${bride.father}</span> &amp; Mrs. <span class="font-semibold text-slate-900 dark:text-slate-100">${bride.mother}</span>`;
